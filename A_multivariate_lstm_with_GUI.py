...
class GroundwaterPredictionApp:
    ...
    def append_to_csv(self):
        ...
        if filename:
            ...
            results_text = f"{results[0]},{self.activation_function},{self.lstm_units},{self.hidden_layers},{self.dropout_rate},{results[1]},{results[2]},{results[3]},{results[4]}\n"

            # Append results to CSV
            if not os.path.exists(filename):
                header = "Epochs,Activation Function,Number of LSTM Units,Number of Hidden Layers,Dropout Rate,MSE,RMSE,MAE,R2\n"
